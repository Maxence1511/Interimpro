...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: '40%', right: '10%', width: '120px', height: '120px', borderRadius: '50%', background: 'rgba(244,114,182,0.10)', pointerEvents: 'none' }} />
      ...
      <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '26px', fontWeight: 800, color: '#581c87', marginBottom: '6px', letterSpacing: '-0.5px' }}>
            InterimPro
          </h1>
          <p style={{ fontSize: '14px', color: '#9333ea', fontWeight: 500 }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(20px)', border: '1px solid rgba(232,123,249,0.2)', borderRadius: '20px', padding: '32px', boxShadow: '0 8px 40px rgba(147,51,234,0.10)' }}>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#3b0764', marginBottom: '4px' }}>
            {isRegister ? 'Créer un compte' : 'Connexion'}
          </h2>
          <p style={{ fontSize: '13px', color: '#a855f7', marginBottom: '24px' }}>
          ...
          <button onClick={handleGoogle} disabled={loading} style={{
            ...
            background: 'white', border: '1.5px solid rgba(232,123,249,0.3)',
            cursor: loading ? 'not-allowed' : 'pointer', marginBottom: '20px',
            fontSize: '14px', fontWeight: 600, color: '#3b0764',
            boxShadow: '0 2px 8px rgba(232,123,249,0.12)',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="vous@exemple.com"
                style={{ width: '100%', padding: '11px 14px', borderRadius: '10px', border: '1.5px solid rgba(232,123,249,0.25)', background: 'rgba(255,255,255,0.8)', color: '#3b0764', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} />
            </div>
            <div>
            ...
            {msg.text && (
              <div style={{ padding: '10px 14px', borderRadius: '8px', background: msg.ok ? '#f0fdf4' : '#fef2f2', border: '1px solid ' + (msg.ok ? '#86efac' : '#fca5a5'), fontSize: '13px', color: msg.ok ? '#166534' : '#dc2626' }}>
                {msg.text}
              </div>
            )}
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: 'linear-gradient(135deg, #e87bf9 0%, #a855f7 100%)',
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '16px' }}>
            <button style={{ fontSize: '13px', color: '#c084fc', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
              Mot de passe oublié ?
            </button>
